...
import { exportPortableWarmProjection } from './portable-warm-projection-exporter.js';
...
export async function exportPortableWarmProjectionForTool({
  bundlePath = '',
  bundleDir = '',
  outputRoot = ''
} = {}) {
  return exportPortableWarmProjection({
    bundlePath,
    bundleDir,
    outputRoot
  });
